...
export default function TinyMCE({
  ...
  const tinymce_key = process.env.VITE_TINY_MCE_KEY;
  ...
  return (
    <Editor
      ...
      init={{
        ...
        plugins:
          'ai insertdatetime tinycomments mentions anchor autolink charmap codesample emoticons image link lists media searchreplace table visualblocks wordcount checklist mediaembed casechange export formatpainter pageembed permanentpen footnotes advtemplate advtable advcode editimage tableofcontents mergetags powerpaste autocorrect a11ychecker typography inlinecss emoticons',
        toolbar:
